...
function validate() {
  ...
  var quiz = ["Forward","Turn Right", "Forward"];
  let x = 0;
//For applying duration on movements
  ...
  //Function to change direction to "turn right"
  ...
  //  //Function to change direction to "Forward"
  ...
  alert("Congratulations Car You passed the Quiz!");
 //Go through the array of "sent" commands
  for (let i=0; i < newArr.length; i++){
